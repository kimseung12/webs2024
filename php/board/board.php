    ...
    <main id="main" role="main">
        ...
        <div class="intro__img small">
            ...
            <div class="intro__text">
                <h2>게시판</h2>
                <p>
                    웹디자이너, 웹 퍼블리셔, 프론트엔트 개발자를 위한 게시판입니다.<br>관련된 문의사항은 여기서 확인하세요!
                </p>
            </div>
        </div>
...
<?php
    ...
    // 31~40 LIMIT 30, 10 --> page3 ($viewNum * 4) -$viewNum
...
<?php
    // 총 페이지 갯수
    $boardTotalCount = ceil($boardTotalCount/$viewNum); //29.4이면 --> 30페이지로 올림
